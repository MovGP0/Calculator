...
namespace Calculator.Controls.Variables
{
    ...
    {
        public static readonly DependencyProperty TextProperty = DependencyProperty.Register(nameof(Text), typeof(string), typeof(Constant), new PropertyMetadata(default(string)));
        ...
        public static readonly DependencyProperty BaselineOffsetProperty = DependencyProperty.Register(
            nameof(BaselineOffset), typeof(double), typeof(Constant), new PropertyMetadata(default(double)));
        ...
        static Constant()
        {
            FontSizeProperty.OverrideMetadata(typeof(Constant), 
